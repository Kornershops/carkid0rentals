...
export default function GigVehiclesPage() {
  ...
  const locations = useMemo(() => {
    return Array.from(new Set(ecoGigVehicles.map(l => l.location))).sort();
  }, [ecoGigVehicles]);
  ...
  const filteredVehicles = useMemo(() => {
    ...
    if (sourceFilter !== 'all') {
      filtered = filtered.filter(v => v.lister.role === sourceFilter);
    }
    ...
    return filtered;
  }, [searchQuery, locationFilter, fuelTypeFilter, sourceFilter, priceSort, ecoGigVehicles]);
        ...
        <Container size="xl">
          ...
          <div className="py-12 border-b border-gray-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-semibold text-gray-900">Eco-Gig Vehicles</h1>
                <p className="text-lg text-gray-600">{filteredVehicles.length} fuel-efficient vehicles available</p>
              </div>
            </div>
          </div>
          ...
          <div className="py-6 border-b border-gray-200">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <Select options={fuelTypeOptions} value={fuelTypeFilter} onChange={(e) => setFuelTypeFilter(e.target.value)} fullWidth />
          ...
          <div className="py-6">
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Why Choose Eco-Gig Vehicles?</h3>
          ...
          <div className="py-12 border-t border-gray-200">
            <div className="bg-gray-900 rounded-lg p-8 md:p-12 text-center">
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">Ready to Start Earning?</h2>
